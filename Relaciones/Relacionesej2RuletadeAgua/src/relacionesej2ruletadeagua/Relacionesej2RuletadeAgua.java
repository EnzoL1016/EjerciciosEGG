...
package relacionesej2ruletadeagua;
...
public class Relacionesej2RuletadeAgua {
   static Scanner leer = new Scanner(System.in).useDelimiter("\n"); 
  
    public static void main(String[] args) {
        System.out.println("Antes de empezar ingrese el numero de jugadores: ");
        int nn = leer.nextInt();
        Juego nuevo = new Juego(nn); 
        while(!nuevo.findeljuego()){
            nuevo.ronda();
        }
