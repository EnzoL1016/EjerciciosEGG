...
public class G1ejercicio9extra {
    ...
    int cociente = dividendo/divisor; int resto = dividendo%divisor; int x=0;
    while (dividendo>0){
        x++;
        dividendo=dividendo-divisor;
    }    
        System.out.println("El cociente de esta división es "+cociente); 
